                    ...
                    <div className="w-full lg:w-1/2 lg:px-8 py-6">
                        ...
                        <ul className="flex flex-col gap-2 ">
                            <li>
                                ...
                                <p className="text-xm text-gray-700">(+213)667119749</p>
                            </li>
                            <li>
                                <h3 className="text-xl text-gray-800 font-medium mb-1">Email</h3>
                                <p className="text-xm text-gray-700">mohammed.amin.mostefaoui@gmail.com </p>
                            </li>
                            <li>
                                <h3 className="text-xl text-gray-800 font-medium mb-1">Address</h3>
                                <p className="text-xm text-gray-700">Chettia, chlef Algeria</p>
                            </li>
                        </ul>
                    </div>
                </div>
